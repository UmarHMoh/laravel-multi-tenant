...
const form = useForm({
    ...
    allow_multiple_builder_pages: false,
            ...
            <form @submit.prevent="submit" class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input v-model="form.transaction_fee_percent" type="number" step="0.01" min="0" max="100" class="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2" placeholder="5" />
                    ...
                    <div>
                        ...
                        <input v-model="form.transaction_fee_fixed" type="number" step="0.01" min="0" class="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2" placeholder="0.30" />
