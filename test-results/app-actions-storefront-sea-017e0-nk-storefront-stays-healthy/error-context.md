...
- Name: app-actions.spec.js >> storefront search and filters are usable when product grid exists, otherwise blank storefront stays healthy
- Location: tests/browser-audits/app-actions.spec.js:90:1
...
Call log:
  ...
  - waiting for locator('body')
    23 × locator resolved to <body class="bg-gray-200/80 font-sans antialiased dark:bg-gray-950/95">…</body>
       - unexpected value "
...
- main:
  ...
  - text: Database Queries mysql (2.51 ms)
