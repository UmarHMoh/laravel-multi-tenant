...
test('tenant customer management page loads and searches safely', async ({ page }) => {
  await loginTenant(page);

  await page.goto('http://tenant1.localhost:8000/manage/customer');
  await expectPageHealthy(page);

  await expect(page.locator('body')).toContainText(/Customers|No customers found/i);
