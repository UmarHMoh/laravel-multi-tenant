...
$checks = array (
  ...
  array (
    ...
    'needle' => 'Storefront preview',
    'name' => 'storefront preview exists',
  ),
  1 => 
  array (
    'type' => 'file_contains',
    'file' => 'resources/js/pages/tenant/website/Editor.vue',
    'needle' => 'product card image uses image url',
    'name' => 'product card image uses image url',
  ),
  2 => 
  array (
    'type' => 'file_contains',
    'file' => 'resources/js/pages/tenant/website/Editor.vue',
    'needle' => 'blank space reduced',
    'name' => 'blank space reduced',
  ),
);
