...
$checks = array (
  ...
  array (
    ...
    'needle' => 'function updateSetting',
    'name' => 'updateSetting exists',
  ),
  1 => 
  array (
    'type' => 'file_contains',
    'file' => 'resources/js/pages/tenant/website/Editor.vue',
    'needle' => 'function settingValue',
    'name' => 'settingValue exists',
  ),
  2 => 
  array (
    'type' => 'file_contains',
    'file' => 'resources/js/pages/tenant/website/Editor.vue',
    'needle' => 'Heading: {{ section.settings.heading }}',
    'name' => 'heading binding exists',
  ),
);
